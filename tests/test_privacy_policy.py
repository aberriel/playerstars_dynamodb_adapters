...
from playerstars_adapters import PrivacyPolicyAdapter
...
def test_privacy_policy_adapter(mock1, mock2, mock3):
    adapter = PrivacyPolicyAdapter('console', 'localhost-db')
    assert adapter
